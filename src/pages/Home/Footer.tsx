...
const Footer = () => {
  ...
  return (
    <footer className="flex flex-col items-start justify-center p-4 md:items-center dark:bg-neutral-950">
      <p className="md:text-center">
        © {new Date().getFullYear()} Abdelrahman - Built using React + Tailwind
      </p>
      <div className="relative flex justify-center gap-1">
        All right reserved
        <AnimatedThemeToggler />
        <div className="font-handwritten absolute top-0 left-36 flex justify-center gap-1">
          <svg
            width="60"
            height="41"
            viewBox="0 0 219 41"
          ...
          <p className="font-black text-nowrap">Change Theme From Here</p>
        </div>
      </div>
    </footer>
  );
